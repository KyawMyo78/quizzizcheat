...
$postJson->response = new stdClass();
...
$postJson->response->provisional = new stdClass();
$postJson->response->provisional->scores = new stdClass();
$postJson->response->provisional->scores->correct = 0;
$postJson->response->provisional->scores->incorrect = 0;
$postJson->response->provisional->scoreBreakups = new stdClass();
$postJson->response->provisional->scoreBreakups->correct = new stdClass();
...
$postJson->response->provisional->scoreBreakups->incorrect = new stdClass();
...
$postJson->response->provisional->teamAdjustments = new stdClass();
